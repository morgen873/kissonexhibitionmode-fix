...
function generate360Prompt(recipeTitle: string, imagePrompt?: string): string {
  if (imagePrompt) {
    return `create a complete 360-degree orbital camera movement around a dumpling on a pure solid matte black background, showing it from all angles - front, back, left, right, top, and bottom views. The dumpling must maintain its exact original shape and appearance throughout the entire video. Only the camera moves in a smooth circular orbit - the dumpling remains completely unchanged and stationary. No morphing, no transformation, no shape changes. Pure solid matte black background, no textures, no patterns, no gradients, completely black void background, no distractions, no extras, dumpling is the sole focus. The video should be seamless and loop-ready.`;
  }
  return `create a complete 360-degree orbital camera movement around a dumpling on a pure solid matte black background, showing it from all angles - front, back, left, right, top, and bottom views. The dumpling must maintain its exact original shape and appearance throughout the entire video. Only the camera moves in a smooth circular orbit - the dumpling remains completely unchanged and stationary. No morphing, no transformation, no shape changes. Pure solid matte black background, no textures, no patterns, no gradients, completely black void background, no distractions, no extras, dumpling is the sole focus. The video should be seamless and loop-ready.`;
}
