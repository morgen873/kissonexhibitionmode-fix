...
const CreationLayout: React.FC<CreationLayoutProps> = ({
  ...
  return <div className="min-h-screen w-full overflow-x-hidden">
      ...
      <TransitionAnimation isVisible={isTransitioning} direction={transitionDirection} onComplete={completeTransition} variant={transitionVariant} />

      {/* Enhanced Footer with better text visibility */}
      {!hasStartedCreation && <AnimatedContainer variant="slide" delay={200}>
