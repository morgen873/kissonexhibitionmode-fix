...
const IntroStepContent: React.FC<IntroStepContentProps> = ({
  ...
  const renderStepContent = () => {
    switch (step.type) {
      case 'hero':
        return (
          <div className="text-center max-w-lg mx-auto px-4">
            ...
            <p className="text-base sm:text-lg text-white font-bold mb-6 sm:mb-8 font-mono leading-relaxed">
      ...
      case 'explanation':
        ...
        return (
          <Card className="bg-transparent border-4 border-white/20 transition-all duration-300 shadow-2xl shadow-black/25 w-full max-w-xs sm:max-w-sm mx-auto">
  ...
  return (
    <main className="flex flex-col items-center justify-center flex-grow w-full min-h-[50vh]">
      {renderStepContent()}
    </main>
  );
};
