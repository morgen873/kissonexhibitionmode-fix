...
const IntroFlow = ({ onComplete }: IntroFlowProps) => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-purple-900 via-pink-900 to-orange-900 text-white flex flex-col justify-center items-center p-4 relative overflow-hidden pt-24">
